                                ...
                                for(e = -(w - 1) ; e < w; e++){
                                	...
                                	if((k[i] + h < 0) || (t[i] + e < 0) || (k[i] + h > 13) || (t[i] + e > 13)) {
                                        ...
                                        if(place_able){
                                                        ...
                                                        if(selfarea1 > mostselfarea1){
                                                            ...
                                                            if(arccombo > mostarccombo){
                                                                ...
                                                                if(oppedgenum > mostoppedge){
                                                                    ...
                                                                    else if(totalarea == mosttotalarea){
                                            ...
                                            if(m == 11 && j == 0 && l == 3 && (k[i] + h == 0) && (t[i] + e == 4)){
                                                printf(" l=3 %d, %d, %d, %d, %d ", totalcreatearea, totalelmarea ,totalarea, arccombo, selfarea1);
                                            }
                                            if(m == 11 && j == 0 && l == 0 && (k[i] + h == 3) && (t[i] + e == 11)){
                                               printf(" l=0 %d, %d, %d, %d, %d ", totalcreatearea, totalelmarea ,totalarea, arccombo, selfarea1);
                                            }
