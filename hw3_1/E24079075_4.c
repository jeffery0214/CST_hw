...
int main(int argc, char *argv[]){
    ...
    if(firstplace(Board)){
        ...
        int mosttotalarea1 = -10000;
        int mosttotalarea2 = -10000;
        int mostselfarea1 = 0;
        int moseselfarea2 = 0;
                                	...
                                	if((k[i] + h < 0) || (t[i] + e < 0) || (k[i] + h > 13) || (t[i] + e > 13)) {
                                        ...
                                        if(place_able){
                                            ...
                                            if(oppo){
                                                ...
                                                if(totalarea >= mosttotalarea2){
                                                    if(totalarea > mosttotalarea1){
                                                        mosttotalarea1 = totalarea;
                                                        place_r = k[i] + h;
                                                        place_c = t[i] + e;
                                                        placeini_r = ini_r;
                                                        placeini_c = ini_c;
