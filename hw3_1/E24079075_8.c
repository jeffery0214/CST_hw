...
#define ROW 14//棋盤行
#define COLUMN 14//棋盤列
#define PUZNUM 21//拼圖數量
#define PUZRC 5//拼圖行列

typedef const char* String;//定義字串長量
