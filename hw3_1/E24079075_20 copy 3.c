...
int findmin(int distance, int minidistance){
...
void arcdistance(int selfarc_r, int selfarc_c, int *opparc_r, int *opparc_c, int oppboardarcnum, int *totaldistance){
    int i, x, y;
    *totaldistance = 0;
    for(i = 0; i < oppboardarcnum; i++){
        x = selfarc_r - opparc_r[i];
        y = selfarc_c - opparc_c[i];

        *totaldistance = *totaldistance + pow(x, 2) + pow(y, 2);
    }
}
...
void arccombocount(char Board[ROW][COLUMN][20], char puzzle[PUZNUM][PUZRC][PUZRC][20], int *returncombo, int pattern[PUZNUM], String color, String color2, int arc_r, int arc_c, int combodest, int *comboextraarea, int *predicttime){
                            ...
                            for(e = -(w - 1) ; e < w; e++){
                                ...
                                if((arc_r + h < 0) || (arc_c + e < 0) || (arc_r + h > 13) || (arc_c + e > 13)) {
                                    ...
                                    if(place_able){
                                        ...
                                        arcarea2(Board, combodest, arc_r, arc_c, comboextraarea, color, color2);
                                        ...
                                        if(combonum != 0){
                                            ...
                                            for(n = 0; n < combonum; n++){
                                                *predicttime = predict_temp;
                                                ...
                                                arccombocount(Board_temp, puzzle_temp, &arccombo, pattern_temp, color, color2, comboarc_r[n], comboarc_c[n], dest[n], &extraareadcare, predicttime);
                                            }
                                        }
...
int main(int argc, char *argv[]){
    ...
    if(firstplace(Board, color)){
        ini_end(puzzle[16], &ini_r, &ini_c, &end_r, &end_c, color);
        if(strcmp(Board[9][9], color2) == 0){
            place(3,4,&ini_r,&end_r,&ini_c,&end_c,Board,puzzle[16]);
        }
        else if(strcmp(Board[4][4], color2) == 0){
            
            ini_end(puzzle[16], &ini_r, &ini_c, &end_r, &end_c, color);
            place(8,7,&ini_r,&end_r,&ini_c,&end_c,Board,puzzle[16]);
        }
        else{
            place(3,4,&ini_r,&end_r,&ini_c,&end_c,Board,puzzle[16]);
        }
        ...
        int mostextraarea = -10;
        int mosttotalcreatrarea = 0;
        int mostselfarea1 = 0;
        int moseselfarea2 = 0;
        int mostarccombo = 0;
        ...
        findarc(Board, disarc_r, disarc_c, &disarcn, color2);
        for(m = 0; m < 21; m++){
            if(pattern[m] == 1){
                for(i = 0; i < n; i++){
                    for(j = 0; j < 2; j++){
                                ...
                                for(e = -(w - 1) ; e < w; e++){
                                	...
                                	if((k[i] + h < 0) || (t[i] + e < 0) || (k[i] + h > 13) || (t[i] + e > 13)) {
                                        ...
                                        if(place_able){
                                            ...
                                            arcdistance(k[i] + h, t[i] + e, disarc_r, disarc_c, disarcn, &distance);
                                            ...
                                            if(mostminidistance < 0){
                                                mostminidistance = distance;
                                            }
                                            if(combonum != 0){
                                                for(z = 0; z < 14; z++){
                                                    for(s = 0; s < 14; s++){
                                                ...
                                                for(z = 0; z < combonum; z++){
                                                   ...
                                                   arccombocount(Board_temp, puzzle_temp, &arccombo, pattern_temp, color, color2, comboarc_r[z], comboarc_c[z], combodest[z], &extraarea, &predicttime);
                                            ...
                                            if(oppo){
                                                ...
                                                else if(extraarea >= mosttotalcreatrarea){
                                                    if(arccombo > mostarccomboopp){
                                                ...
                                                if(totalcreatearea > mostextraarea){
                                                    if(selfarea2 > moseselfarea2){
                                                        ...
                                                        mosttotalcreatrarea = totalcreatearea;    
                                                        ...
                                                        if(selfarea1 > mostselfarea1){
                                                            ...
                                                            else if(distance == mostminidistance){
