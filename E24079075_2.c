        ...
        for(j = ini_c; j < end_c+1; j++){
            ...
            if(strcmp((*puzzle)[i][j], color) == 0){
                if(m == 0 && n == 0){
                    ...
                    else if(strcmp(Board[m+1][n+1], color) == 0){
                        elmarc_r[*elmnum] = m;
                        elmarc_c[*elmnum] = n;
                        *elmnum = *elmnum + 1;
                        *elmin = true;
                    }
                    else if(strcmp(Board[m+1][n+1], color2) == 0){
                    ...
                    else if((strcmp(Board[m+1][n+1], color) == 0) || (strcmp(Board[m+1][n-1], color) == 0)){
                        elmarc_r[*elmnum] = m;
                        elmarc_c[*elmnum] = n;
                        *elmnum = *elmnum + 1;
                        *elmin = true;
                    }
                    else if((strcmp(Board[m+1][n+1], color2) == 0) || (strcmp(Board[m+1][n-1], color2) == 0)){
                        opparc_r[*opparcnum] = m;
                        opparc_c[*opparcnum] = n;
                        *opparcnum = *opparcnum + 1;
                        *oppo = true;
                    ...
                    if((i + 1 > end_r) && (j - 1 < ini_c)){
                        ...
                        *elmin = true;
                            ...
                            || (strcmp(Board[m+1][n+1], color2) == 0)  || (strcmp(Board[m+1][n-1], color2) == 0)){
                        opparc_r[*opparcnum] = m;
                        opparc_c[*opparcnum] = n;
                        *opparcnum = *opparcnum + 1;
                        *oppo = true;
